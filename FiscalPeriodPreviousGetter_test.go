...
func Test_Previous_20220710_Should_Return_20200901_To_20210831(t *testing.T) {
	...
	assert.Equal(t, dateSimple(2020, time.September, 1), fiscalPeriod.Start, "Start fiscal period should be 2020-09-01 for 2022-07-10")
	assert.Equal(t, dateSimple(2021, time.August, 31), fiscalPeriod.End, "End fiscal period should be 2021-08-31 for 2022-07-10")
}
