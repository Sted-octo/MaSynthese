...
func Test_One_Permanent_Before_Pivot_TimeDone_Shoulbe_1(t *testing.T) {
	timeInputs = new(TimeInput)
	timeInputs.Add(timeInputElementNotBillableAt(123, "intercontrat", 1, time.Date(2022, time.June, 10, 0, 0, 0, 0, TimeZoneGetter("Europe/Paris"))))
...
func Test_One_Permanent_After_Pivot_TimeDone_Shoulbe_1(t *testing.T) {
	timeInputs = new(TimeInput)
	timeInputs.Add(timeInputElementNotBillableAt(123, "intercontrat", 1, time.Date(2022, time.July, 10, 0, 0, 0, 0, TimeZoneGetter("Europe/Paris"))))
